...
* $P(B \mid E)$, por definição, é

  $$
  \begin{aligned}
  P(B \mid E) &= \frac{P(B \cap E)}{P(E)} \\
  &= \frac{1/2 \cdot 5/100}{3/40} \\
  &= \frac{1}{3}
  \end{aligned}
  $$

* Agora, calcular $P(B \mid \neg E) \cdot P(\neg E)$:

  $$
  \begin{aligned}
  P(B \mid \neg E) &= \frac{P(B \cap \neg E)}{P(\neg E)} \\
  &= \frac{1/2 \cdot 90/100}{37/40} \\
  &= \frac{18}{37}
  \end{aligned}
  $$
...
* Daí
  ...
  P(B \mid \neg E) \cdot P(\neg E) \\
  &=
  \frac13 \cdot \frac{3}{40} \;+\; \frac{18}{37} \cdot \frac{37}{40} \\
  &= 
  \frac{19}{40}
  \end{aligned}
  $$
